...
def get_config():
  ...
  # config.model_init = (
  #     '/troy/anuj/gub-og/checkpoints/vit_imgnet21k/B_16-i21k-300ep-lr_0.001-aug_medium1-wd_0.1-do_0.0-sd_0.0.npz')
  # config.model_init = 'gs://ue-usrl-anuj/vit-simclr-outputs/1680700740884/checkpoint_900.npz'
  config.model_init = 'gs://ue-usrl-anuj/vit-simclr-outputs/1682511673043/8/checkpoints/checkpoint_10000.npz'
  # config.model_init = (
  ...
  config.total_and_warmup_steps = (20_000, 500)
