...
run_settings = [
	('baselines.isic.jax_finetune_osp', {
			'output_dir': 'gs://ue-usrl-anuj/karm/outputs/isic/head_neck/vit_osp/llr_<_llr>/plr_<_plr>/<_seed>',
			'config': 'configs/isic/vit_finetune_osp.py',
			'config.seed': '<_seed>',
