...
class ChexpertCustomConfig(tfds.core.BuilderConfig):
  ...
  def __init__(self, target_pixels=None, blur_constant=None, **kwargs):
    ...
    """
    super(ChexpertCustomConfig, self).__init__(
...
class ChexpertCustom(tfds.core.GeneratorBasedBuilder):
  ...
  def _split_generators(self, dl_manager):
    ...
    return [
        tfds.core.SplitGenerator(
            name=split,
            gen_kwargs={
                "images_dir_path": os.path.join(path, "chexpert_custom", split),
                "split": split,
                "csv_path": os.path.join(path, "chexpert_custom", f"{split}.csv"),
            })
        for split in splits
    ]
...
class ChexpertCustomDataset(base.BaseDataset):
  ...
  def __init__(self,
    ...
    print(f"Using ChexpertCustom builder config {builder_config}.")
    dataset_builder = tfds.builder(builder_config, data_dir=data_dir)
    super(ChexpertCustomDataset, self).__init__(
