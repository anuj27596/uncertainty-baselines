...
def main(argv):
  ...
  def evaluation_fn(params, images, labels):
    ...
    losses = (
        ...
        + 0.01 * train_utils.softmax_xent(logits=logits_1, labels=labels, reduction=False)
        + 0.01 * train_utils.softmax_xent(logits=logits_2, labels=labels, reduction=False))  # EDIT(anuj)
  ...
  def update_fn(opt, lr, images, labels, rng):
    ...
    def loss_fn(params, images, labels):
      ...
      loss = (
          ...
          + 0.01 * train_utils.softmax_xent(logits=logits_1, labels=labels)
          + 0.01 * train_utils.softmax_xent(logits=logits_2, labels=labels))  # EDIT(anuj)
