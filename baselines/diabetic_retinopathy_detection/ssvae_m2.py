...
flags.DEFINE_string(
    'output_dir', '/tmp/diabetic_retinopathy_detection/ssvae_m2',
...
def main(argv):
  ...
  with strategy.scope():
    ...
    if FLAGS.load_from_checkpoint:
      ...
      initial_epoch = 0
      model = ub.models.resnet50_ssvae_m2(
  ...
  gen_loss_fn = utils.m2_generative_loss_fn
  ...
  uncertainty_estimator_fn = utils.get_uncertainty_estimator( # TODO(anuj): checkout
      'ssvae_m2', use_ensemble=False, use_tf=True)
