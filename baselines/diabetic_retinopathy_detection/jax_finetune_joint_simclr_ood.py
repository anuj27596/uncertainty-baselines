...
def main(argv):
  ...
  def evaluation_fn(params, images, labels):
    ...
    losses = (
        ...
        + train_utils.softmax_xent(logits=logits_1, labels=labels, reduction=False)
        + train_utils.softmax_xent(logits=logits_2, labels=labels, reduction=False))  # EDIT(anuj)
