...
# from baselines.diabetic_retinopathy_detection.train_utils import LocalSpatialLoss
...
def main(argv):
  ...
  base_loss_fn = train_utils.LocalSpatialLoss(neg_mode='random') #anuj
  ...
  model_dict = vit_utils.initialize_model('local_spatial', config)  # EDIT(anuj)
