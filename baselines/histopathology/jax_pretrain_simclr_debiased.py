...
def main(argv):
  ...
  def evaluation_fn(params, images, labels):
    ...
    losses = train_utils.simclr_loss_debiased(projections=projections, reduction=False)  # EDIT(anuj)
  ...
  def update_fn(opt, lr, images, labels, rng):
    ...
    def loss_fn(params, images, labels):
      ...
      return train_utils.simclr_loss_debiased(projections=projections)  # EDIT(anuj)
