...
def get_pneumonia_base_metrics(
    use_tpu: bool,
    num_bins: int,
  ...
  Note:
    ...
    `get_pneumonia_cpu_eval_metrics` method for initializing AUCs.
...
def log_vit_validation_metrics(eval_results):
  ...
  eval_metrics = ['negative_log_likelihood', 'accuracy', 'auroc'] # Karm
